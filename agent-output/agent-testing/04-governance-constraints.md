...
| ----------- | -------- | ------------- | ---------------------- |
| Environment | ✅ Yes   | CAF default   | `test`                 |
| ManagedBy   | ✅ Yes   | CAF default   | `Bicep`                |
| Project     | ✅ Yes   | CAF default   | `agent-testing`        |
| Owner       | ✅ Yes   | CAF default   | `platform-engineering` |
| TTL         | ✅ Yes   | Cleanup logic | `2h`                   |
...
| ---------- | -------------------------------------------------------------------------------- |
| 🟢 **Low** | No blocking policies detected. All policies are audit or DeployIfNotExists mode. |
