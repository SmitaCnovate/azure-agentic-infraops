...
> **Note**: This project was created before the Deploy agent was integrated into the
> workflow (December 2025). The `06-deployment-summary.md` artifact is not present because
> deployment was performed manually outside the agentic workflow. New projects using the
> full 7-step workflow will have this artifact generated by the `@deploy` agent.
>
> **Legacy naming**: This demo uses `06-asbuilt-*` instead of `07-ab-*`.
